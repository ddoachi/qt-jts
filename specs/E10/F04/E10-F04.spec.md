# Feature E10-F04: Metrics Calculator
...
- [ ] Sharpe ratio correctly annualized (×252 return, ×√252 std)
...
- Sortino Ratio: `(R_p - R_f) / σ_d` (downside deviation)
